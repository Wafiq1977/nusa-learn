...
export const LEVELS: LevelDef[] = [
  // Number City
  { id: 'nc-1', areaId: 'number_city', name: 'Level 1 — Kereta Energi', subtitle: 'Penjumlahan awal', brief: 'Bantu NOVA mengaktifkan kereta energi dengan menyelesaikan soal penjumlahan.', order: 1, gameType: 'catch', subcategory: 'penjumlahan', difficulty: 'easy', questionCount: 5, emoji: '🚂' },
  ...
  { id: 'nc-3', areaId: 'number_city', name: 'Level 3 — Pabrik Robot', subtitle: 'Perkalian', brief: 'Kalahkan robot pabrik dengan perkalian dalam pertarungan!', order: 3, gameType: 'battle', subcategory: 'perkalian', difficulty: 'medium', questionCount: 5, emoji: '🤖' },
  { id: 'nc-4', areaId: 'number_city', name: 'Level 4 — Stasiun Pembagian', subtitle: 'Pembagian', brief: 'Bagi energi ke semua kereta secara rata melalui jalur.', order: 4, gameType: 'path', subcategory: 'pembagian', difficulty: 'medium', questionCount: 5, emoji: '🚉' },
  { id: 'nc-boss', areaId: 'number_city', name: 'Boss — Belanja & Waktu', subtitle: 'Uang & Waktu', brief: 'Beli suku cadang di toko dan hitung waktu tempuh misi!', order: 5, gameType: 'shop', difficulty: 'hard', questionCount: 6, emoji: '👑', isBoss: true },
  ...
  { id: 'lf-3', areaId: 'literacy_forest', name: 'Level 3 — Jembatan Kosakata', subtitle: 'Kosakata', brief: ' Cocokkan kata dengan artinya untuk menyeberang jembatan.', order: 3, gameType: 'path', subcategory: 'kosakata', difficulty: 'medium', questionCount: 5, emoji: '🌉' },
  ...
  { id: 'll-2', areaId: 'logic_lab', name: 'Level 2 — Kode Robot', subtitle: 'Pola lanjutan', brief: 'Tebak kode akses robot dengan pola yang lebih sulit.', order: 2, gameType: 'catch', subcategory: 'pola', difficulty: 'medium', questionCount: 5, emoji: '🔑' },
  ...
  { id: 'll-4', areaId: 'logic_lab', name: 'Level 4 — Timbangan', subtitle: 'Perbandingan', brief: 'Gunakan perbandingan untuk menyeimbangkan timbangan.', order: 4, gameType: 'path', subcategory: 'perbandingan', difficulty: 'medium', questionCount: 5, emoji: '⚖️' },
  { id: 'll-boss', areaId: 'logic_lab', name: 'Boss — Pemecahan Masalah', subtitle: 'Pola & logika', brief: 'Selesaikan misi logika terakhir di lab!', order: 5, gameType: 'battle', difficulty: 'hard', questionCount: 6, emoji: '👑', isBoss: true },
  ...
  { id: 'fs-2', areaId: 'future_station', name: 'Level 2 — Pola Bintang', subtitle: 'Pola bilangan', brief: 'Temukan pola rasi bintang.', order: 2, gameType: 'catch', subcategory: 'pola', difficulty: 'medium', questionCount: 5, emoji: '⭐' },
  { id: 'fs-3', areaId: 'future_station', name: 'Level 3 — Rasio Bahan Bakar', subtitle: 'Perbandingan', brief: 'Hitung perbandingan bahan bakar roket.', order: 3, gameType: 'battle', subcategory: 'perbandingan', difficulty: 'hard', questionCount: 5, emoji: '🚀' },
  ...
  { id: 'fs-boss', areaId: 'future_station', name: 'Boss — Misi Penjelajah Sejati', subtitle: 'Campuran numerik & literasi', brief: 'Buktikan kamu layak menjadi penjelajah sejati dengan misi campuran!', order: 5, gameType: 'path', difficulty: 'hard', questionCount: 7, emoji: '👑', isBoss: true },
